...
public class JavascriptUtils {
    /**
     * * Use this method in need of clicking on a WebElement internally. This is
     * used * when WebDriver is failed to click on a WebElement UI. * * @param web
     * Element
     */
    ...
    /**
     * * Use this method in need of clearing WebElement internally. This is used
     * when * WebDriver is failed to clear a text box value. * * @param web Element.
     */
    ...
    /** * This method will scroll page up by the given pixel * * @param pixel */
    ...
    /**
     * * Use this method in need of generating alert in runtime while an issue
     * raises. * * @param object of WebDriver. * @param message Pass the message you
     * want to generate.
     */
     ...
     * selenium WebDriver. * * @param driver Pass the object of WebDriver here.
     */
    ...
    /**
     * * Use this method in need of retrieving the page title. * * @param driver
     * pass the object of WebDriver here. * @return string object.
     */
    ...
    /**
     * * Use this method in need of retrieving the whole page text. * * @param
     * driver Pass the object of the WebDriver here. * @return string object.
     */
    ...
    /**
     * * Use this method in need of sending text to a web element. * * @param
     * element * @param value
     */
     ...
     * * and date desired in String format as arguments * * @param element * @param
     * date to be selected
     */
    ...
    /**
     * * This method will scroll text up by the given pixel * * @param pixel
     * * @param element
     */
    ...
    /**
     * * This method will scroll screen by the given pixel * * @param pixel * @param
     * pixel
     */
