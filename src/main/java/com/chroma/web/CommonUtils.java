...
public class CommonUtils extends WebDriverUtils {
     ...
     * WebDriver. * * @param element Pass the element to which the text needs to be
     * entered. * @param value Pass the desired text/value in the second parameter.
     */
     ...
     * selenium WebDriver. * * @param element Pass the element to which the key
     * needs to be entered. * @param keyboardKey Pass the desired keyboardKey to be
     * entered to an element.
     */
    ...
    /**
     * * Use this method in need of retrieving the text of an element through
     * selenium * WebDriver. * * @param element Pass the element from which the text
     * to be retrieved. * @return This method returns a string object.
     */
     ...
     * * VisbleText. * * @param dropDownElement Pass the WebElement of the desired
     * dropDown. * @param ValueOfDropDown Pass the Visible text of DropDown to be
     * selected.
     */
    ...
    /**
     * * Use this over loaded method in need of selecting an element of dropDown by
     * * Value. * * @param dropDownElement Pass the value to be selected. * @param
     * ValueOfDropDown Pass the WebElement of the dropDown.
     */
    ...
    /**
     * * Use this over loaded method in need of selecting an element of dropDown by
     * * index. * * @param dropDownElement WebElement of the dropDown. * @param
     * indexOfDropDownValue Pass the index
     */
    ...
    /**
     * * this method will accept the alert * * @throws will throw NoAlertExeption if
    ...
    /**
     * * this method will dismiss the alert * * @throws will throw NoAlertExeption
    ...
    /**
     * * this method will get the alert text * * @throws will throw NoAlertExeption
     * if alert is not present.
     */
    ...
    /** * This method will switch to the frame * * @param nameOrId */
    ...
    /** * use this method in need of switching to the frame * * @param element */
    ...
    /** * This method will switch to the frame * * @param index */
    ...
    /**
     * * This method will determine if element is present on ui or not. * * @param
     * element * @return
     */
     ...
     * availability of elementToBeSelected. * * @param element Pass the WebElement
     * on which synchronization to be applied. * @return This method will return
    ...
    /**
     * * This method will create an Object of WebDriverWait * * @return
     * WebDriverWait
     */
    ...
    /**
     * * This method will wait until element becomes clickable * * @param element
     */
    public static void waitForClickability(WebElement element) {
        getWaitObject().until(ExpectedConditions.elementToBeClickable(element));
    }

    /** * This method will wait until element becomes visible * * @param element */
    public static void waitForVisibility(WebElement element) {
        getWaitObject().until(ExpectedConditions.visibilityOf(element));
    }

    /**
     * * This method will wait until element becomes invisible * * @param element
     */
     ...
     * * @param yourValue * @return Will return the updated value
     */
    ...
    /**
     * * Use this method to select a drop down value from a ServiceNow drop down
     * menu * when Select class will not work NOTE: Before using, first you must
     * click on * the drop down, then store elements in a list
     */
    ...
    /**
     * * Use this method to pass an email concatenated with current date and time
     * into * an email text box
     */
    ...
    /**
     * * Use this String to pass an email concatenated with current date and time
     * into * an email text box and you can pass same value (email+date+time) in
     * another * steps.
     */
    public static String email = getEmail();

    /**
     * * Use this method to pass date as a string. You can concatinate with any
     * String * and get unique name
     */
    ...
    /**
     * * Use this method to select a checkbox value * @throws InterruptedException
     */
     ...
     * displayed * @throws InterruptedException
     */
    ...
    /*
     * * * Use below method to assert actual String value with an expected String
     * value
    ...
    /** * * Use this method to assert a boolean condition * @param flag */
