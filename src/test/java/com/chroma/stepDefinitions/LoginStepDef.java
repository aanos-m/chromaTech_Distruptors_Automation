...
public class LoginStepDef {
    ...
    public void a_CTSMS_user_is_on_the_home_page () {
        WebDriverUtils.driver.get(ApplicationConstants.CTSMS_TestURL);
    }

    @When ("the user logs in with valid crendentials")
    public void the_user_logs_in_with_valid_crendentials () {
